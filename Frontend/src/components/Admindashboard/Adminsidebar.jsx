...
import { LayoutDashboard, Video, FileText, LogOut, UserPlus } from "lucide-react"; // npm install lucide-react
...
export default function Adminsidebar() {
  ...
  const menuItems = [
    { name: "Home", path: "/admindashboard", icon: <LayoutDashboard size={20} /> },
    { name: "Create User", path: "/admin-create-user", icon: <UserPlus size={20} /> },
    { name: "Credentials", path: "/admindashboard/credentials", icon: <Video size={20} /> },
    { name: "Lectures", path: "/admindashboard/lectures", icon: <FileText size={20} /> },
  ];
