...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: "Home", path: "/studentdashboard", icon: <LayoutDashboard size={20} /> },
    { name: "Lectures", path: "/studentdashboard/lectures", icon: <Video size={20} /> },
    { name: "Assignment", path: "/studentdashboard/assignment", icon: <FileText size={20} /> },
  ];
        ...
        <div className="p-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-indigo-600">Student</p>
            </div>
          </div>
        </div>
