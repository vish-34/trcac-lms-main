...
export default function AdminLogin() {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (
          ...
          setError(
            "This login is for administrators only. Please use the student/teacher login."
          );
        }
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND */}
      <div className="absolute w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] bg-white blur-[120px] opacity-30 -top-20 -left-20" />

      <div className="absolute w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] bg-white blur-[120px] opacity-30 bottom-0 right-0" />
